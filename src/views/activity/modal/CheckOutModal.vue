<template>
  <BaseModal title="체크아웃 등록" @close="close">
    <div class="form">
    ...
    <template #footer>
      ...
      <BaseButton type="warning" size="sm" @press="submit">
        체크아웃 등록
      </BaseButton>
    </template>
  </BaseModal>
...
import { createCheckOutApi } from '@/api/reservation/checkinoutApi.js'

const props = defineProps({
  stayCode: { type: Number, required: true },
})
