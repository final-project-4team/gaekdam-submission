...
/**
 * IdClass for ReportCXKPIFact composite primary key
 */
public class ReportCXKPIFactId implements Serializable {
    private static final long serialVersionUID = 1L;

    private LocalDate kpiDate;
    private Long hotelGroupCode;

    public ReportCXKPIFactId() {
    }

    public ReportCXKPIFactId(LocalDate kpiDate, Long hotelGroupCode) {
    ...
    public boolean equals(Object o) {
        ...
        ReportCXKPIFactId that = (ReportCXKPIFactId) o;
