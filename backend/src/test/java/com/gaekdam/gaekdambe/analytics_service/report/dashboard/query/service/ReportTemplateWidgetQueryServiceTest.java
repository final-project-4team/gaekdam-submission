...
class ReportTemplateWidgetQueryServiceTest {
    ...
    ReportTemplateWidgetQueryService service;
    ...
    void setUp() {
        ...
        service = new ReportTemplateWidgetQueryService(templateRepo, widgetRepo, metricService);
    }
    ...
    void listByTemplateId_timeseries_whenTitleIndicatesChange_usesTimeSeries() {
        ...
        MetricTimeSeries mts = new MetricTimeSeries(List.of("2025-01","2025-02"), List.of(new MetricTimeSeries.Series("s1", List.of(BigDecimal.ONE, BigDecimal.TEN))));
